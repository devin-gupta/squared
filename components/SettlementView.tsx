    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-6">
        <div className="text-center">
          <div className="text-2xl font-serif text-accent/40 mb-2">All settled</div>
          ...
          <div className="space-y-3">
            {settlements.map((settlement, idx) => (
              <motion.div
                ...
                className="px-4 py-4 bg-accent/5 border border-accent/10 rounded-lg"
                whileHover={{ scale: 1.01, backgroundColor: 'rgba(45, 48, 46, 0.1)' }}
              >
                <div className="flex items-center justify-between">
                  <div>
                    <div className="text-lg font-medium text-accent font-sans">
                      {settlement.from} → {settlement.to}
                    </div>
                    <div className="text-sm text-accent/60 mt-1 font-sans">
